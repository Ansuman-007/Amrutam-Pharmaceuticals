  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover expert doctors for in-clinic sessions tailored to your needs. Select your location, expertise, and language preferences to find the perfect specialist for hair care, infertility, and more."
        />
      </Helmet>
                      ...
                      <div className="flex flex-col items-center gap-3.5 self-stretch">
                        <div className="flex flex-col items-start gap-1.5">
                          <div className="flex items-start gap-[15px]">
                            <Img src="images/img_frame.svg" alt="image_one" className="mt-0.5 h-[16px] w-[16px]" />
                        ...
                        <div className="flex justify-evenly gap-2 self-stretch">
                          <div className="flex flex-col items-center justify-center gap-1 rounded-[10px] border border-solid border-green-800_63 bg-orange-50 p-1">
                            <Heading as="h3" className="mt-[3px] tracking-[-0.14px] !text-gray-800_01">
                              Video Consultation
                            </Heading>
                          ...
                          <div className="flex flex-col items-center justify-center gap-1 rounded-[10px] border border-solid border-green-800_63 bg-orange-50 p-1">
                            <Heading as="h5" className="mt-[3px] tracking-[-0.14px] !text-gray-800_01">
                              Chat Consultation
                            </Heading>
