...
export default function DesktopSeventyThreePage() {
  return (
    <>
      <Helmet>
        <title>Dr. Bruce Willis - Experienced Gynecologist | Book Your Appointment</title>
        <meta
          name="description"
          content="Meet Dr. Bruce Willis, a renowned Gynecologist with over 7 years of experience in women's health, skin care, and more. Book an appointment for personalized care in pregnancy, endometriosis, and other concerns."
        />
      </Helmet>
